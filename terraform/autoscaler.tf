// Apply Cluster Autoscaler to cluster (https://github.com/kubernetes/autoscaler)
// Give AWS permissions to access and modify AWS auto-scaling groups
// and specify the Kubernetes namespace and a service account name where we're going to deploy cluster-autoscaler
